...
def _get_file_types_for_project_with_py_tests(project):
    ...
    file_types[_read_files.ParseFileType.SingularTest]["extensions"].append(".py")
    return file_types
...
def _singular_test_render_update(self, node, config, validate_config_call_dict=False):
