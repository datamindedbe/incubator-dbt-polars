...
class BaseDocsGenerate(BaseGenerateProject):
    ...
    def test_run_and_generate(self, project, expected_catalog):
        ...
        # Check that assets have been copied to the target directory
        # for use in the docs html page
    ...
    def test_locally_run_and_generate(self, project, expected_catalog):
        # Change to random directory to test that assets doc generation
        # works with project-dir
