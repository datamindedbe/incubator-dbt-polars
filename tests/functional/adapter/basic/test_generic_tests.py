...
generic_test_grouped_model_yml = """
version: 2
...
class BaseGenericTests:
    ...
    def models(self):
        return {
            "grouped_model.sql": base_table_sql,
            "table_model.sql": base_table_sql,
            "schema.yml": schema_base_yml,
            "schema_grouped.yml": generic_test_grouped_model_yml,
    ...
    def test_generic_tests(self, project):
        ...
        assert "model.generic_tests.grouped_model" in result_log_lines[0]
